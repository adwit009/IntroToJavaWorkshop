...
if(tortoiseLocationX == 140 && tortoiseLocationY == 40){
	...
	JOptionPane.showMessageDialog(null,"Go to the map in a bottle");
	
}if(tortoiseLocationX == 280 && tortoiseLocationY == 370){
	JOptionPane.showMessageDialog(null,"go to the cannon");
	
}if(tortoiseLocationX == 480 && tortoiseLocationY == 180){
	JOptionPane.showMessageDialog(null,"Go to the fat green necked parrot");
	
}if(tortoiseLocationX == 420 && tortoiseLocationY == 100){
	JOptionPane.showMessageDialog(null,"Go to the wooden sword");
	
}if(tortoiseLocationX == 380 && tortoiseLocationY == 310){

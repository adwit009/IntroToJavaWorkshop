...
int background = -5560023;
int background2 = -14046365;
		//6. if the mouse falls off the path (if it is on the background)
		if (mouseColor== -5560023 || mouseColor == -14046365) {
			try {
				scare();
			} catch (Exception e1) {
	...
	private void scare() throws Exception {
